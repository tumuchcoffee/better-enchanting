# Blocks & Items — Minecraft 26.1.2

Complete vanilla registries extracted from the patched Minecraft 26.1.2.77 decompiled sources (`Blocks.java` / `Items.java`).

- **Blocks:** 1054
- **Items:** 1543 (includes all block-items; pure items are listed separately below)
