...
This plan covers the first two implementation milestones for the Enchantment Mod. Task #1 builds the pedestal structure needed for Level 2+ upgrades. Task #2 adds the first working enchantment: Fire Aspect I, crafted at a standard crafting table.
...
## Task #2 — Fire Aspect I crafting recipe
