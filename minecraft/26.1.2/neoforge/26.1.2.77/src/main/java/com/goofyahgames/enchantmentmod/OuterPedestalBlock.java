...
public class OuterPedestalBlock extends BaseEntityBlock {
    ...
    @Override
    public MapCodec<OuterPedestalBlock> codec() {
        return CODEC;
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new OuterPedestalBlockEntity(pos, state);
    }
    ...
    public BlockState playerWillDestroy(Level level, BlockPos pos, BlockState state, Player player) {
        if (level.getBlockEntity(pos) instanceof OuterPedestalBlockEntity pedestal) {
