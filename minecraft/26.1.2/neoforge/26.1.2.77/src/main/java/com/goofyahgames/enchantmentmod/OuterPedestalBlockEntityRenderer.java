...
@OnlyIn(Dist.CLIENT)
public class OuterPedestalBlockEntityRenderer implements BlockEntityRenderer<OuterPedestalBlockEntity, OuterPedestalRenderState> {

    private final ItemModelResolver itemModelResolver;

    public OuterPedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        this.itemModelResolver = context.itemModelResolver();
    }

    @Override
    public OuterPedestalRenderState createRenderState() {
        return new OuterPedestalRenderState();
    }

    @Override
    public void extractRenderState(
            OuterPedestalBlockEntity blockEntity,
            OuterPedestalRenderState state,
            float partialTicks,
            Vec3 cameraPosition,
    ...
    @Override
    public void submit(OuterPedestalRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera) {
